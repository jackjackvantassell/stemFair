...
const concepts = [
  {
    ...
    description: (
      <div>
        This is the intro to learning to code using Stone Story RPG game. You
        should download the game in the app store because that version is free.
        to download. If you download it through other means, it costs money.
        Both are the same games, just different costs. Anyway, download it and
        just play. You have to play until you get the mind stone. Also, one more
        thing. Remember to have FUN. I built this tutorial so you could have fun
        while learning coding, not for it to be boring.
        <a
          className="a-tag"
          href="https://apps.apple.com/pl/app/stone-story-rpg/id1076120218"
          target="_blank"
        >
          click here to download stone story
        </a>
      </div>
    ),
  },
...
const App = () => {
  return (
    <div className="App">
      <SideNavbar concepts={concepts} />
      <MiddleContent concepts={concepts} />
    </div>
  );
};
